        ...
        <div className="xs:h-16 flex xs:flex-row flex-col items-center justify-center lg:gap-10 gap-6 rounded-3xl xs:py-0 py-5 bg-dark-navy">
          ...
          <div className="lg:hidden flex items-center gap-3 text-std-slate">
            <a href={githubLink} target={"_blank"}>
              <FiGithub className="w-5 h-5 cursor-pointer hover:stroke-std-green hover:-translate-y-1 transition-all" />
            </a>
            <a href={linkedinLink} target={"_blank"}>
              <FiLinkedin className="w-5 h-5 cursor-pointer hover:stroke-std-green hover:-translate-y-1 transition-all" />
            </a>
          </div>
        </div>
      </motion.footer>
